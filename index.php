      ...
      <div class="container">
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav text-uppercase">
            ...
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="./agendaControl.php">Agenda</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="./annuaireControl.php">Annuaire</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="./aideControl.php">Aide</a>
            </li>
          </ul>
        </div>
      </div>
